...
{
    const fcab_prv_dni = req.body.fcab_prv_dni
    ...
    const cabecera = await cabecera_model.CreateCabecera(fcab_prv_dni, fcab_fecha_init, fcab_fecha_fin, fcab_tipo_pago)
...
async function UpdateCabecera(req, res)
{
    ...
    try 
    {
        const cabecera = await cabecera_model.UpdateCabecera(fcab_id, fcab_prv_dni, fcab_fecha_init, fcab_fecha_fin, fcab_tipo_pago)
        res.status(200).send({mensaje: cabecera,
                              body: {
                                fcab_id: fcab_id,
                                fcab_prv_dni: fcab_prv_dni,
